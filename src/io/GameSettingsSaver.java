...
public class GameSettingsSaver {
    ...
    public void saveGameSettingsToTempFileWithUserFolder(ArrayList<JComboBox> coreJComboBoxes
            , ArrayList<JComboBox> videoSettingsJComboBoxes
            , ArrayList<JComboBox> videoEnhancementsJComboBoxes
            , ArrayList<JComboBox> videoHacksJComboBoxes
            , JComboBox videoHardwareJComboBox
            ...
            , ArrayList<JComboBox> wiiJComboBoxes
            , ArrayList<JComboBox> controlJComboBoxes
            , ArrayList<JComboBox> controlProfileJComboBoxes) {
        ...
        String dspAudioSetting = saveDSPAudioSetting(dspAudioVolumeSlider);
        String wiiSettings = saveSettings(wiiJComboBoxes, "Wii", ConfigNames.WII_OPTIONS);
        String controlSettings = saveControlSettingsWithUserFolder(controlJComboBoxes, controlProfileJComboBoxes);
    ...
    private String saveControlSettingsWithUserFolder(ArrayList<JComboBox> controlJComboBoxes, ArrayList<JComboBox> controlProfileJComboBoxes) {
        String controlSettings = "";
        boolean isChanged = false;
        for (int i=0; i<controlJComboBoxes.size(); i++) {
            if (controlJComboBoxes.get(i).getSelectedIndex() != 0) {
        ...
        if (!isChanged) {
            ...
            controlSettings += "[Controls]\n";
            int comboBoxesChecked = 0;
            int profileComboBoxesChecked = 0;
            ...
            for (int i = 0; i<ConfigNames.CONTROL_OPTIONS.length; i++) {
                ...
                if (!ConfigNames.CONTROL_OPTIONS[i].contains("Profile")) {
                    ...
                    if (controlProfileJComboBoxes.get(profileComboBoxesChecked).getSelectedIndex() > 0) {
                        String settingValue = ConfigNames.CONTROL_OPTIONS[i] + "=" + controlProfileJComboBoxes.get(profileComboBoxesChecked).getItemAt(controlProfileJComboBoxes.get(profileComboBoxesChecked).getSelectedIndex()).toString().trim() + "\n";
                        controlSettings += settingValue;
                    }
                    profileComboBoxesChecked++;
                }
