...
public class ConfigNames {
    ...
    public static final String[] coreOptions = {"Dual Core", "Graphics Backend", "CPU Emulator Engine", "DSP HLE", "Emulation Speed"
    ...
    public static final String[] videoSettingsOptions = {"Internal Resolution", "Shader Compilation", "Compile Shaders Before Starting"
    ...
    public static final String[] videoHardwareOption = {"V-Sync"};
    public static final String[] dspAudioOption = {"Volume"};
    public static final String[] wiiOptions = {"Wii Language", "Wii Aspect Ratio"};
    public static final String[] controlOptions = {"GameCube Controller Port 1", "GameCube Controller Port 2", "GameCube Controller Port 3", "GameCube Controller Port 4"
